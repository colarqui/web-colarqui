            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <div className="mt-9 flex flex-col sm:flex-row gap-3">
                  <Link
                    href="/colegios"
                    className="inline-flex items-center justify-center gap-2 bg-brand-dark text-white px-7 py-4 rounded-full font-semibold hover:bg-[#1f1b14] transition-colors"
                  >
                  ...
                  <Link
                    href="/admisiones"
                    className="inline-flex items-center justify-center gap-2 bg-white text-brand-dark border border-[#e4dccf] px-7 py-4 rounded-full font-semibold hover:bg-[#f3ead9] transition-colors"
                  >
                    Proceso de admisión
                  </Link>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-14 items-center">
              <div>
                ...
                <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 border-t border-[#2a261f]">
                  {[
                    { n: "31", l: "colegios", c: "text-white" },
                    { n: "29K+", l: "estudiantes", c: "text-brand-gold" },
                    { n: "60+", l: "años", c: "text-white" },
                    { n: "3", l: "municipios", c: "text-brand-coral" },
                  ].map((s, i) => (
                    <div key={i} className="py-5 pr-4 border-r border-[#2a261f] last:border-r-0">
                      <div
                        className={`text-3xl leading-none ${s.c}`}
                        style={{ fontFamily: "var(--font-archivo)", fontWeight: 800 }}
                      >
                        {s.n}
                      </div>
        ...
        <section className="bg-[#FBF6EE]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="max-w-2xl mb-12">
              <span className="text-[11px] font-semibold tracking-[0.18em] uppercase text-[#c0533f]">
                Acompañamos todo el camino
              </span>
              <h2
                className="mt-3 text-3xl md:text-4xl text-brand-dark leading-tight"
                style={{ fontFamily: "var(--font-fraunces)", fontWeight: 600 }}
              >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {niveles.map((n, i) => (
                <div
                  key={i}
                  className="group bg-white rounded-2xl p-6 border border-[#efe6d7] hover:border-brand-coral/40 transition-colors"
                >
            ...
            <div className="grid md:grid-cols-3 gap-7">
              {destacados.map((c, i) => (
                <Link
                  key={i}
                  href="/colegios"
                  className="group bg-[#FBF6EE] rounded-2xl overflow-hidden border border-[#efe6d7] hover:shadow-xl hover:shadow-brand-dark/5 transition-all"
                >
        ...
        <section className="bg-brand-coral">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <div className="mt-9 flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/admisiones"
                className="inline-flex items-center justify-center gap-2 bg-brand-dark text-white px-8 py-4 rounded-full font-semibold hover:bg-[#1f1b14] transition-colors"
              >
