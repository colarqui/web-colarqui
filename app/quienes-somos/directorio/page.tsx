...
const colegios = [
  { nombre: "Unidad Administrativa", sede: null, exts: [
  ...
  { nombre: "Colegio Bartolomé Mitre", sede: null, exts: [{ ext: "1300", area: "Secretaría" }, { ext: "1310", area: "Rectoría" }, { ext: "1320", area: "Coordinación" }, { ext: "1340", area: "Psicología" }] },
  { nombre: "Colegio Parroquial San Pedro Claver", sede: null, exts: [{ ext: "2200", area: "Secretaría Académica" }, { ext: "2210", area: "Rectoría" }, { ext: "2220", area: "Coordinación General" }, { ext: "2240", area: "Psicología" }] },
  { nombre: "Santa Isabel de Hungría", sede: "Alfonso López", exts: [{ ext: "3500", area: "Secretaría / Recepción" }, { ext: "3510", area: "Rectoría" }, { ext: "3520", area: "Coordinación Académica" }, { ext: "3521", area: "Coordinación Bienestar" }, { ext: "3522", area: "Coordinación General Escuela Taller" }, { ext: "3523", area: "Coordinación Académica 2" }, { ext: "3540", area: "Psicología y Enfermería" }] },
  { nombre: "I.E. Llano Verde", sede: "Calimio Desepaz", exts: [{ ext: "3600", area: "Secretaría Académica" }, { ext: "3621", area: "Coordinación Académica" }, { ext: "3623", area: "Coordinación Bienestar" }] },
  { nombre: "I.E. Llano Verde", sede: "Calimio Norte", exts: [{ ext: "3700", area: "Secretaría Auxiliar" }, { ext: "3701", area: "Secretaría Académica" }, { ext: "3710", area: "Rector" }, { ext: "3740", area: "Psicología" }] },
  { nombre: "Colegio Santa Isabel de Hungría", sede: "Ciudad 2000", exts: [{ ext: "3800", area: "Secretaría Académica" }, { ext: "3810", area: "Rectoría" }, { ext: "3820", area: "Coordinación Académica" }, { ext: "3840", area: "Psicología" }] },
  { nombre: "I.E. Llano Verde", sede: "Aguacatal", exts: [{ ext: "4300", area: "Secretaría Auxiliar" }, { ext: "4301", area: "Secretaría Académica" }, { ext: "4310", area: "Rectoría" }, { ext: "4320", area: "Coordinación" }, { ext: "4340", area: "Psicología" }] },
  { nombre: "Colegio Parroquial San Francisco Javier", sede: "Orquídeas", exts: [{ ext: "4600", area: "Secretaría Académica" }, { ext: "4610", area: "Rectoría" }, { ext: "4620", area: "Coordinación Académica" }, { ext: "4640", area: "Psicología" }] },
  { nombre: "Colegio Mayor Santiago de Cali", sede: null, exts: [{ ext: "4900", area: "Secretaría Académica" }, { ext: "4910", area: "Rector" }, { ext: "4920", area: "Coordinación General" }, { ext: "4940", area: "Psicología" }] },
  { nombre: "I.E. Llano Verde", sede: "Comuneros II", exts: [{ ext: "5000", area: "Secretaría Académica" }, { ext: "5010", area: "Rector" }, { ext: "5020", area: "Coordinación Bienestar" }, { ext: "5040", area: "Psicología" }] },
  { nombre: "I.E. Llano Verde", sede: "Invicali", exts: [{ ext: "4000", area: "Secretaría" }, { ext: "4010", area: "Rectoría" }, { ext: "4021", area: "Coordinación de Bienestar" }, { ext: "4040", area: "Psicología" }] },
  { nombre: "I.E. Llano Verde", sede: "San Felipe", exts: [{ ext: "4100", area: "Secretaría Académica" }, { ext: "4110", area: "Rectoría" }, { ext: "4120", area: "Coordinación Académica" }, { ext: "4121", area: "Coordinación de Bienestar" }] },
  { nombre: "I.E. Llano Verde", sede: "San Luis", exts: [{ ext: "4200", area: "Secretaría" }, { ext: "4210", area: "Rector" }, { ext: "4220", area: "Coordinación Académica" }, { ext: "4240", area: "Psicología" }] },
  { nombre: "I.E. Llano Verde", sede: "Sede Principal", exts: [{ ext: "6000", area: "Secretaría" }, { ext: "6010", area: "Rectoría" }, { ext: "6020", area: "Coordinación" }, { ext: "6040", area: "Psicología" }, { ext: "6090", area: "Portería" }] },
  { nombre: "Colegio Nuestra Señora de Chiquinquirá", sede: null, exts: [{ ext: "7000", area: "Secretaría Académica" }, { ext: "7010", area: "Rectoría" }, { ext: "7020", area: "Coordinación General" }, { ext: "7040", area: "Psicología" }] },
  { nombre: "Colegio La Presentación El Paraíso", sede: null, exts: [{ ext: "8000", area: "Secretaría" }, { ext: "8010", area: "Rectoría" }, { ext: "8020", area: "Coordinación" }, { ext: "8040", area: "Psicología" }] },
  { nombre: "Institución Educativa Nelson Garcés Vernaza", sede: null, exts: [{ ext: "9000", area: "Secretaría" }, { ext: "9010", area: "Rectoría" }, { ext: "9020", area: "Coordinación Académica" }, { ext: "9030", area: "Coordinación Bienestar" }, { ext: "9040", area: "Bibliobanco" }] },
];

const directos = [
  { nombre: "Institución Nuestra Señora del Rosario", sede: "Jamundí", tel: "553 0847", exts: [{ ext: "3400", area: "Secretaría" }, { ext: "3410", area: "Rectoría" }, { ext: "3420", area: "Coordinación" }, { ext: "3440", area: "Psicología" }] },
  { nombre: "Institución Educativa San Francisco Javier", sede: "Yumbo", tel: "669 1960", exts: [{ ext: "3100", area: "Secretaría" }, { ext: "3110", area: "Rectoría" }, { ext: "3120", area: "Coordinación" }, { ext: "3140", area: "Psicología" }] },
  { nombre: "La Providencia", sede: null, tel: "403 2287", exts: [{ ext: "—", area: "Secretaría" }] },
];

export default function DirectorioPage() {
  const [q, setQ] = useState("");
  const match = (c: any) => `${c.nombre} ${c.sede || ""}`.toLowerCase().includes(q.toLowerCase());
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {colegios.filter(match).map(c => (
                <div key={`${c.nombre}-${c.sede || "u"}`} className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                  <div className="mb-3"><h3 className="font-bold text-brand-dark">{c.nombre}</h3>{c.sede && <p className="text-xs text-brand-coral-dark font-medium">{c.sede}</p>}</div>
