...
import { INFORME_2024 } from "@/data/informe2024";
import type { Fundacion2024 } from "@/data/informe2024";
...
export default function Informe2024Page() {
  ...
  const fetchComments = useCallback(async () => {
    try {
      const res = await fetch(`/api/informes-comentarios?fundacion=${key}&anio=2024`);
  ...
  const submitComment = async () => {
    ...
    try {
      const res = await fetch("/api/informes-comentarios", {
        ...
        body: JSON.stringify({ nombre, comentario, fundacion: key, anio: 2024 }),
      });
      ...
      <main className="min-h-screen">
        ...
        <section className="relative bg-brand-dark overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
            ...
            <p className="font-bold text-sm tracking-widest uppercase mb-3 text-white">Impacto Social 2024</p>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-3">
              Informe de Gestión <span className="text-brand-gold">2024</span>
            </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Section icon={DollarSign} title="Rendición" accent="de Cuenta">
            ...
            {data.ingresosDetalle && data.ingresosDetalle.length > 0 && (
              <div className="mb-10">
                <h3 className="text-lg font-bold text-brand-dark mb-1">Ingresos <span className="text-brand-gold">2024</span></h3>
          ...
          {/* ═══ Donantes ════════════════════════════════════════ */}
          <Section icon={HandHeart} title="Donantes" accent="2024">
