    ...
    <>
      ...
      <main className="min-h-screen">
        <PageHero
          ...
          subtitulo="Conoce cómo las fundaciones educativas reinvierten los recursos en actividades meritorias de educación, salud y cultura para generar impacto social en la región."
          acciones={
            <a href="#reportes" className="inline-flex items-center justify-center gap-2 bg-brand-gold text-brand-dark px-7 py-4 rounded-full font-semibold hover:bg-[#ffc94d] active:scale-[0.98] transition-all">
              Ver reportes anuales <ChevronRight className="h-4 w-4" />
            </a>
          }
        >
          Informes de <span className="italic text-brand-gold">gestión social</span>
        </PageHero>
