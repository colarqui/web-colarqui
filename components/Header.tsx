      ...
      <div className="bg-brand-dark text-white text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hidden lg:flex items-center justify-end gap-6 h-9">
            ...
            <Link href="/quienes-somos/directorio" className="text-white/80 hover:text-brand-gold transition-colors flex items-center gap-1.5">
              <Phone className="h-3.5 w-3.5" /> Directorio Telefónico
            </Link>
            <Link href="/quienes-somos/trabaja-con-nosotros" className="text-brand-gold hover:text-brand-gold/80 transition-colors flex items-center gap-1.5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <Link href="/colegios" className={navLink}>Colegios</Link>
              <Link href="/admisiones" className={navLink}>Admisiones</Link>
              <Link href="/noticias" className={navLink}>Noticias</Link>
          ...
          {isMenuOpen && (
            <nav className="lg:hidden py-4 border-t border-[#efe6d7] max-h-[70vh] overflow-y-auto">
              <div className="flex flex-col gap-1">
                ...
                <Link href="/colegios" onClick={() => setIsMenuOpen(false)} className="px-2 py-2 font-medium text-brand-dark hover:text-brand-coral">Colegios</Link>
                <Link href="/admisiones" onClick={() => setIsMenuOpen(false)} className="px-2 py-2 font-medium text-brand-dark hover:text-brand-coral">Admisiones</Link>
                <Link href="/noticias" onClick={() => setIsMenuOpen(false)} className="px-2 py-2 font-medium text-brand-dark hover:text-brand-coral mt-1">Noticias</Link>
                ...
                <Link href="/quienes-somos/directorio" onClick={() => setIsMenuOpen(false)} className="pl-4 py-2 text-sm text-[#6a6358] hover:text-brand-coral flex items-center gap-2">
                ...
                <Link href="/quienes-somos/trabaja-con-nosotros" onClick={() => setIsMenuOpen(false)} className="pl-4 py-2 text-sm text-[#6a6358] hover:text-brand-coral flex items-center gap-2">
