...
// Enlaces apuntan a /* para navegar dentro del universo del rediseño.
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/colegios" className="text-[#a9a194] hover:text-white transition-colors">Nuestros colegios</Link></li>
              <li><Link href="/admisiones" className="text-[#a9a194] hover:text-white transition-colors">Proceso de admisión</Link></li>
              <li><Link href="/noticias" className="text-[#a9a194] hover:text-white transition-colors">Noticias</Link></li>
              <li><Link href="/transparencia" className="text-[#a9a194] hover:text-white transition-colors">Transparencia</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3"><FileText className="h-5 w-5 text-brand-gold flex-shrink-0" /><Link href="/quienes-somos/directorio" className="text-[#a9a194] hover:text-white transition-colors">Directorio de colegios</Link></li>
              <li className="flex items-center gap-3"><MessageSquare className="h-5 w-5 text-brand-gold flex-shrink-0" /><Link href="/servicios/pqrsf" className="text-[#a9a194] hover:text-white transition-colors">Radicar PQRSF</Link></li>
              <li className="flex items-center gap-3"><HelpCircle className="h-5 w-5 text-brand-gold flex-shrink-0" /><Link href="/#faq" className="text-[#a9a194] hover:text-white transition-colors">Preguntas frecuentes</Link></li>
            </ul>
          </div>
