            ...
            {!showContactForm && messages.length > 2 && (
              <div className="flex gap-2">
                <button
                  ...
                  disabled={loading}
                  className={`flex-1 flex items-center justify-center gap-2 py-1.5 text-xs rounded-lg transition-colors border disabled:opacity-40 ${
                    showEscalateButton
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-3 py-1.5 text-xs text-white bg-green-600 hover:bg-green-700 rounded-lg transition-colors"
